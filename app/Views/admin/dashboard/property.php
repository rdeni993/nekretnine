...
<div class="container-fluid mt-3">
    <div class="row">
        ...
        <div class="dashboard-item bg-light p-5">
            <h1 class="text-secondary"><i class="fa fa-map"></i> Kontrola nekretnina</h1>
            <hr>
                        ...
                        <tbody>
                            <?php foreach($properties as $prop): ?>
                                <tr data-table-id="<?php echo esc($prop->ID); ?>">
                                    ...
                                    <td class="text-right">
                                    <button class="delete-prop btn btn-danger" data-id="<?php echo esc($prop->ID); ?>">Obriši</button>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="<?php echo site_url('adminservice/add_property') ?>" method="POST" id="add_property">
                                <!-- All Simple Types use this -->
                                <input class="form-control" type="text" name="prop_type" placeholder="e.g flat" />
                                <input type="hidden" name="db_table" value="property_type" />
                                <input type="hidden" name="db_uri_back" value="admin/property" />
