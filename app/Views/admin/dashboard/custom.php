...
<div class="container-fluid mt-3">
    <div class="row">
        ...
        <div class="dashboard-item bg-light p-5">
            <h1 class="text-secondary"><i class="fa fa-puzzle-piece"></i> Kontrola Dodatnih polja</h1>
            <hr>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="<?php echo site_url('adminservice/add_property') ?>" method="POST" id="add_property">
                                <input class="form-control" type="text" name="prop_type" placeholder="e.g Klima" />
                                <input type="hidden" name="db_table" value="customs_type" />
                                <input type="hidden" name="db_uri_back" value="admin/custom" />
                                <br>
